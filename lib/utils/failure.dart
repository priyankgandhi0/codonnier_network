...
abstract class Failure extends Equatable {
  ...
  @override
  String toString() {
    return {'name': message, 'code': code, 'error': error}.toString();
  }
}
...
class Unauthorised extends Failure {
  const Unauthorised(dynamic error) : super('Unauthorized', '401', error);
}
...
class InternetNotAvailable extends Failure {
  const InternetNotAvailable(dynamic error)
      : super('Please check Internet connection', '', error);
}
